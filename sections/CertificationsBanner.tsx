  ...
  return (
    <div className="mt-10">
        ...
        <Slider {...settings} className="w-full md:px-20 px-5 items-center justify-center">
          <div>
            <Image src="/one.png" alt="About us" height={150} width={150}  />
          </div>
          <div>
            <Image src="/two.png" alt="About us" height={150} width={150} />
          </div>
          <div>
            <Image src="/three.png" alt="About us" height={150} width={150} />
          </div>
          <div>
            <Image src="/four.png" alt="About us" height={150} width={150} />
          </div>
          <div>
            <Image src="/five.png" alt="About us" height={150} width={150} />
          </div>
        </Slider>
      </div>
    </div>
