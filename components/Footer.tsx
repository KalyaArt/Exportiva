    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:grid md:grid-cols-4 md:gap-10">
          <div className="col-span-2 mb-6 md:mb-0">
              ...
              <div className="font-montserrat text-gray-400 font-medium mt-6"> 
                  <p>At Expotiva, we take great pride in sourcing and exporting the finest products from Kenya. Our commitment to quality, freshness, and sustainability ensures that you receive nothing but the best. We work closely with farmers and suppliers to maintain strict quality control and ensure that our products meet the highest international standards. onal trade.</p>
              </div>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 Exportiva. All Rights Reserved.</span>
